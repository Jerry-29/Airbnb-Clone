      ...
      <div className="payment-container">
        <div className="left">
          <div className="add">
            ...
            <p>Daleep's place is usually booked.</p>
          </div>
          <h2>Your trip</h2>
          <p>Dates</p>
          <p>
          ...
          <p>
            Free cancellation before 12:00 pm on 24 Mar. After that, cancel
            before 12:00 pm on 25 Mar and get a full refund, minus the first
            night and service fee. Learn more
          </p>
          <p>
